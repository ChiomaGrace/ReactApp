...
router.post(
    `/submitResident`,  
    upload.single('profilePicture'), //middleware that will take the image, upload it to Cloudinary, and return a request.file object with the file information to the controller
    residentController.createResident,
);

// router.post('/submitResident', residentController.createResident);

router.get('/residents', residentController.displayAllResidents)

router.get('/specificResident/:id', residentController.specificResident) //need the id in the params to retrieve the specific Pokemon
